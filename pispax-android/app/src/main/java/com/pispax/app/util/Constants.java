...
public class Constants {
    ...
    // 10.0.2.2 es la dirección que el emulador Android usa para llegar a localhost del PC
    // Si usas un dispositivo físico, cámbialo por la IP WiFi de tu PC (ej: 192.168.1.X)
